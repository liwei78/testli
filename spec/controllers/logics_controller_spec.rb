  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved logic as @logic" do
        ...
        post :create, {:logic => { "title" => "invalid value" }}, valid_session
        assigns(:logic).should be_a_new(Logic)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested logic" do
        ...
        Logic.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => logic.to_param, :logic => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the logic as @logic" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Logic.any_instance.stub(:save).and_return(false)
        put :update, {:id => logic.to_param, :logic => { "title" => "invalid value" }}, valid_session
        assigns(:logic).should eq(logic)
      end
