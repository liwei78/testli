...
describe ScenariosController do
  ...
  describe "GET show" do
    it "assigns the requested scenario as @scenario" do
      ...
      assigns(:cases).should eq(scenario.cases)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved scenario as @scenario" do
        ...
        post :create, {:scenario => { "content" => "invalid value" }}, valid_session
        assigns(:scenario).should be_a_new(Scenario)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested scenario" do
        ...
        Scenario.any_instance.should_receive(:update_attributes).with({ "content" => "MyString" })
        put :update, {:id => scenario.to_param, :scenario => { "content" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the scenario as @scenario" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Scenario.any_instance.stub(:save).and_return(false)
        put :update, {:id => scenario.to_param, :scenario => { "content" => "invalid value" }}, valid_session
        assigns(:scenario).should eq(scenario)
      end
